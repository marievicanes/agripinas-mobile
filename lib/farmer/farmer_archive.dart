...
class FarmerArchive extends StatefulWidget {
  @override
  _FarmerArchiveState createState() => _FarmerArchiveState();
}

class _FarmerArchiveState extends State<FarmerArchive> {
