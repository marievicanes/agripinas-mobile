...
class _CropTrackerScreenState extends State<CropTrackerScreen>
  ...
  List<MarketplaceItem> filteredHarvestItems = [];
  List<HarvestedItem> filteredHarvestedItems = [];
  ...
  void searchItem(String text) {
    setState(() {
      _searchText = text;
      filteredHarvestItems = items
          .where(
              (item) => item.crops.toLowerCase().contains(text.toLowerCase()))
          .toList();
      filteredHarvestedItems = harvesteditems
          .where((item) =>
  ...
  Widget build(BuildContext context) {
    List<MarketplaceItem> displayItemsHarvest =
        _searchText.isEmpty ? items : filteredHarvestItems;
    List<HarvestedItem> displayItemsHarvested =
        _searchText.isEmpty ? harvesteditems : filteredHarvestedItems;
                  ...
                  Stack(
                    children: [
                      GridView.builder(
                        ...
                        itemCount: displayItemsHarvest.length,
                        itemBuilder: (context, index) {
                          final item = displayItemsHarvest[index];
                  ...
                  Stack(
                    children: [
                      GridView.builder(
                        ...
                        itemCount: displayItemsHarvested.length,
                        itemBuilder: (context, index) {
                          final item = displayItemsHarvested[index];
                          return GestureDetector(
                            onTap: () {},
                            child: Card(
                              child: Stack(
