  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: BuyerTransactionDetails(
        productData: {},
        item: CompleteMarketplaceItem(
          completeitemname: '', // provide appropriate values
          comcategory: '',
          dateordered: '',
          unitprice: '',
          quantity: '',
...
class BuyerTransactionDetails extends StatefulWidget {
  ...
  String _searchText = '';
  final Map productData;
  final CompleteMarketplaceItem item;

  BuyerTransactionDetails({required this.productData, required this.item});
        ...
        children: <Widget>[
          Text(
            ...
            style: TextStyle(
              ...
              color:
                  Color(0xFFA9AF7E), // Change this color to your desired color
            ),
          ),
        ],
      ),
