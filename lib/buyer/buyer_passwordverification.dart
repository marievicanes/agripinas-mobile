...
class BuyerPasswordSecurityVerification extends StatelessWidget {
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => BuyerVerifyPassword()));
                    },
                    child: Text(
                      'Send Code',
...
class BuyerVerifyPassword extends StatelessWidget {
  final _formKey = GlobalKey<FormState>();
  final _emailController = TextEditingController();
  String? _codeNumber;
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => BuyerNewPassword()));
                    },
                    child: Text(
                      'Verify',
                      style: TextStyle(fontFamily: 'Poppins'),
...
class BuyerNewPassword extends StatelessWidget {
  final _formKey = GlobalKey<FormState>();
  final _emailController = TextEditingController();
